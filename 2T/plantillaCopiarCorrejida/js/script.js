...
// AVERIGUAR ATRIBUTOS DE CLASE
// const examen = document.getElementsByClassName('examen');
// console.log(examen);
// console.log(examen[1].classList);

// VERIFICAR SI CLASE EXISTE
const examen = document.getElementsByClassName ('.boton_rojo');
// // console.log(examen.classList.contains('izai'));
// optativa.classList.add('mario');

// creamos el event handler
function mostrarCooked(e){
    console.log(e.target.innerText);
}

examen.addEventListener('click', mostrarCooked);
