...
console.log(typeof navegador);
console.log(navegador.innerHTML);
console.log(navegador.innerText);
console.log(navegador.tagName);
...
const rojo = document.querySelector('.botonROJO');
console.log(rojo);

const rojo2 = document.querySelectorAll('.botonROJO');
console.log(rojo2);

// CAMBIANDO COSITAS VISUALES
const cuadroROJO = document.querySelectorAll('.cajaImgBot');
